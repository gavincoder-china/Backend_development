...
import com.gavin.seckill.contants.RedisUserContants;
import com.gavin.seckill.dto.Oauth;
import com.gavin.seckill.mapper.OauthMapper;
import com.gavin.seckill.util.IdWorker;
import com.gavin.seckill.util.RedisUtils;
import com.gavin.seckill.util.UrlUtils;
...
public class UserServiceImpl implements UserService {
    ...
    public String weChatUserLogin(String code) {
        ...
        redisUtils.set(RedisUserContants.LOGIN_NAME_SPACE+accessToken,oauthJsonStr,300);
